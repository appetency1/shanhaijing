...
<template>
  <div class="relative min-h-screen bg-[#050507] text-stone-200 overflow-hidden">
    ...
    >
      <router-link to="/" class="flex items-center gap-2 uppercase">
    ...
    >
      <div class="absolute inset-0 overflow-hidden hero-bg-layer">
        <div class="absolute inset-0 bg-gradient-to-b from-[#020617] via-[#020617] to-black"></div>
        <div
          class="absolute -bottom-10 left-1/2 -translate-x-1/2 w-[140%] h-[55%]
                 bg-[radial-gradient(circle_at_50%_0,rgba(30,64,175,0.7),transparent_60%),radial-gradient(circle_at_20%_80%,rgba(15,23,42,0.9),transparent_55%),radial-gradient(circle_at_80%_80%,rgba(15,23,42,0.9),transparent_55%)]
                 opacity-80"
        ></div>
        <div
    ...
    <section
      id="intro"
      class="page-section relative z-10 bg-gradient-to-b from-black/40 to-black min-h-screen flex items-center"
    >
      <div class="max-w-6xl mx-auto px-6 md:px-12 py-16 w-full">
        <div class="grid md:grid-cols-3 gap-10 items-start">
          <div class="md:col-span-2">
            <p class="text-xs tracking-[0.3em] text-stone-500 font-serif mb-3 uppercase">INTRODUCTION</p>
            <h3 class="text-xl md:text-2xl font-shanhaigu tracking-[0.25em] mb-6">
              何 為 《 山 海 經 》
            </h3>
            <p class="text-sm text-stone-400 font-serif leading-relaxed mb-3">
            ...
            <p class="text-sm text-stone-400 font-serif leading-relaxed">
              在這裡，我們暫時拋下考證，把它視為一套「上古奇幻世界設定集」來閱讀。
            </p>
          </div>

          <div
            class="relative h-full rounded-3xl border border-stone-800/70 bg-gradient-to-br from-[#020617] via-[#020617] to-[#020617] p-5 flex flex-col justify-between"
          >
            <div>
              <p class="text-xs tracking-[0.3em] text-stone-500 font-serif mb-3 uppercase">OVERVIEW</p>
              <ul class="space-y-2 text-xs text-stone-300 font-serif">
                <li>· 成書：大致在先秦 - 西漢之間</li>
                <li>· 結構：《山經》《海經》等篇章</li>
            ...
            <div class="mt-6 text-[10px] text-stone-500 font-serif">
              <span class="inline-block w-10 h-[1px] bg-stone-600 mr-2"></span>
    ...
    <section
      id="geography"
      class="page-section relative z-10 bg-black min-h-screen flex items-center"
    >
      <div class="max-w-6xl mx-auto px-6 md:px-12 py-16 w-full">
        <div class="grid md:grid-cols-2 gap-10 items-start">
          <div>
            <p class="text-xs tracking-[0.3em] text-stone-500 font-serif mb-3 uppercase">GEOGRAPHY</p>
            <h3 class="text-xl md:text-2xl font-shanhaigu tracking-[0.25em] mb-6">
              山 海 四 極 · 五 方 世 界
            </h3>
            <p class="text-sm text-stone-400 font-serif leading-relaxed mb-3">
          ...
          <div
            class="relative rounded-3xl border border-stone-800/70 bg-gradient-to-br from-[#020617] via-[#111827] to-[#020617] p-6 flex flex-col"
          >
            <div class="flex-1 grid grid-cols-2 gap-4 text-xs text-stone-200 font-serif">
              <div>
                <p class="text-stone-500 mb-1">東 方</p>
                <p class="text-[11px] leading-relaxed">
                  多海與日出之地，常與扶桑、朝陽、鳥族與羽族神祇相關。
                </p>
              </div>
              <div>
                <p class="text-stone-500 mb-1">西 方</p>
                <p class="text-[11px] leading-relaxed">
                  多流沙與幽都之境，常見金石之山、刑罰與冥界意象。
                </p>
              </div>
              <div>
                <p class="text-stone-500 mb-1">南 方</p>
                <p class="text-[11px] leading-relaxed">
                  山多而高，炎熱潮濕，鳥獸繁盛，亦有眾多毒蟲與疫瘴。
                </p>
              </div>
              <div>
                <p class="text-stone-500 mb-1">北 方</p>
                <p class="text-[11px] leading-relaxed">
    ...
    <section
      id="beast-jiuweihu"
      class="page-section relative z-10 bg-gradient-to-b from-black via-[#050507] to-black min-h-screen flex items-center"
    >
      <div class="max-w-6xl mx-auto px-6 md:px-12 py-16 w-full flex flex-col md:flex-row items-center gap-10">
        <div class="flex-1">
          <p class="text-xs tracking-[0.3em] text-red-400 font-serif mb-3 uppercase">SPIRIT BEAST</p>
          <h3 class="text-2xl md:text-3xl font-shanhaigu tracking-[0.35em] mb-4">九 尾 狐</h3>
          <p class="text-sm text-stone-400 font-serif leading-relaxed mb-4">
    ...
    <section
      id="beast-taotie"
      class="page-section relative z-10 bg-gradient-to-b from-[#020617] via-black to-[#020617] min-h-screen flex items-center"
    >
      <div class="max-w-6xl mx-auto px-6 md:px-12 py-16 w-full flex flex-col md:flex-row-reverse items-center gap-10">
        <div class="flex-1">
          <p class="text-xs tracking-[0.3em] text-amber-400 font-serif mb-3 uppercase">FEROCIOUS BEAST</p>
    ...
    <section
      id="beast-yinglong"
      class="page-section relative z-10 bg-gradient-to-b from-[#020617] via-[#020617] to-black min-h-screen flex items-center"
    >
      <div class="max-w-6xl mx-auto px-6 md:px-12 py-16 w-full flex flex-col md:flex-row items-center gap-10">
        <div class="flex-1">
          <p class="text-xs tracking-[0.3em] text-sky-400 font-serif mb-3 uppercase">DIVINE DRAGON</p>
    ...
    <section
      ...
      class="page-section relative z-10 bg-black min-h-screen flex items-center"
    >
      <div class="max-w-4xl mx-auto px-6 md:px-12 py-16 w-full text-center">
        <p class="text-xs tracking-[0.3em] text-stone-500 font-serif mb-3 uppercase">
          EPILOGUE
        </p>
        ...
        <p class="text-sm text-stone-400 font-serif leading-relaxed mb-8">
        ...
        <div class="flex flex-wrap justify-center gap-4 text-xs font-serif tracking-[0.25em]">
          <router-link
            to="/explore"
            class="px-6 py-3 rounded-full border border-stone-700/80 hover:border-stone-200 hover:text-stone-100 transition-colors"
          >
            進 入 圖 鑑
          </router-link>
          <router-link
        ...
        <div class="mt-12 text-[10px] text-stone-500 font-serif tracking-[0.2em]">
